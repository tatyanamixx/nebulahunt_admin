...
export function AccountInfoTab({ user, is2FAEnabled }) {
	return (
			...
			<div className="bg-gray-700 shadow rounded-lg border border-gray-600 p-4 sm:p-6">
				...
				<div className="space-y-2 sm:space-y-3">
					<div className="flex flex-col sm:flex-row sm:justify-between gap-1 sm:gap-0">
						...
						<span className="text-sm sm:text-base text-white break-words">{user?.email}</span>
					</div>
					<div className="flex flex-col sm:flex-row sm:justify-between gap-1 sm:gap-0">
						<span className="text-xs sm:text-sm text-gray-400">Role:</span>
						<span className="text-sm sm:text-base text-white">{user?.role}</span>
					</div>
					<div className="flex flex-col sm:flex-row sm:justify-between gap-1 sm:gap-0">
						<span className="text-xs sm:text-sm text-gray-400">2FA Status:</span>
						<span
							className={cn(
