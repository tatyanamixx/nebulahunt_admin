...
import { isDevelopment, isMockApiEnabled } from "./env.js";
...
export const artifactTemplateApi = {
	...
	getBySlug: (slug) => api.get(`/artifact-templates/${slug}`),

	// Create artifact templates
	create: (artifacts) => api.post("/artifact-templates", artifacts),
	...
	delete: (slug) => api.delete(`/artifact-templates/${slug}`),
};
