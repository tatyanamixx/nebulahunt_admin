...
export default function Settings() {
	...
	const handleTestPaymentModeToggle = async (enabled) => {
		try {
			...
			showMessage("Ошибка при обновлении тестового режима платежей", true);
		}
	};
						...
						<div className="mt-6 bg-gray-800 shadow rounded-lg border border-gray-700">
							<div className="px-4 py-4 sm:py-5 sm:p-6">
								<div className="flex flex-col sm:flex-row sm:items-start gap-3 sm:gap-4">
									<div className="flex-shrink-0">
										<div className="inline-flex items-center justify-center p-2 rounded-md bg-yellow-100 text-yellow-600">
											<span className="text-base sm:text-lg">
												🧪
											</span>
										</div>
									...
									<div className="flex-1 min-w-0">
										...
										<p className="text-xs sm:text-sm text-gray-400 mt-1">
											Когда включен, все платежи будут стоить 1
											звезду вместо реальной цены. Полезно для
											тестирования платежной системы.
										</p>
										<div className="mt-4">
											{testPaymentModeLoading ? (
												<div className="h-6 w-6 animate-spin border-2 border-blue-400 border-t-transparent rounded-full" />
											) : (
								...
								<div className="ml-3">
									...
									<div className="mt-2 text-sm text-yellow-300">
										<p>
											...
											баланс и экономику. Убедитесь, что новые
											значения сбалансированы и протестированы.
										</p>
									</div>
								</div>
							</div>
