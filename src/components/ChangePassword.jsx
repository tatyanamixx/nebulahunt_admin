...
import { safeFetch } from "../lib/server-status.js";
...
export default function ChangePassword() {
	...
	const handleSubmit = async (e) => {
		...
		try {
			const result = await safeFetch("/api/admin/password/change", {
				method: "POST",
				headers: {
	...
	return (
		<div className="max-w-md mx-auto bg-white p-6 rounded-lg shadow-md">
			<h2 className="text-2xl font-bold mb-6 text-gray-900">Смена пароля</h2>
